...
def parse_passports(passportStrings):
    ...
    for passport in passportStrings:
        matches = pattern.finditer(passport)
...
def check_passport_fields(passport, requiredKeys):
    for key in requiredKeys:
        if key not in passport or passport[key] == "":
            return False
    return True
...
print("2020 - Day 4 - Part 1")
print(str(num_of_complete_passports(passports)), "valid passports")
# => 237
#    ===

# ---------------------------
# Advent of Code 2020 - Day 4
# Part 2: Passport Processing
# ---------------------------
